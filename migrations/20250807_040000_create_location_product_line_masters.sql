-- =====================================================
-- Location and Product Line Master Data Implementation
-- =====================================================
...
CREATE TABLE profit_center_location_product (
    ...
    encoding_method VARCHAR(20) DEFAULT 'PRODUCT_LOCATION',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (profit_center_id) REFERENCES profitcenter(profitcenterid),
    FOREIGN KEY (location_code) REFERENCES reporting_locations(location_code),
    FOREIGN KEY (product_line_id) REFERENCES product_lines(product_line_id)
);
...
('111100', 'New York City', 'CITY', '111000', 'USA', 'NY', 'NA', 'OFFICE'),
('111110', 'NYC Headquarters', 'SITE', '111100', 'USA', 'NY', 'CORP', 'HEADQUARTERS'),
('111111', 'NYC HQ - Building A', 'BUILDING', '111110', 'USA', 'NY', 'CORP', 'OFFICE'),
('111112', 'NYC HQ - Building B', 'BUILDING', '111110', 'USA', 'NY', 'CORP', 'OFFICE');

-- Manufacturing Sites
INSERT INTO reporting_locations (location_code, location_name, location_level, parent_location, country_code, state_province, city, business_area_id, location_type, is_manufacturing) VALUES
('112000', 'USA - Midwest', 'STATE', '110000', 'USA', 'OH', NULL, 'NA', 'PLANT', TRUE),
('112100', 'Ohio Manufacturing', 'CITY', '112000', 'USA', 'OH', 'Cincinnati', 'PROD', 'PLANT', TRUE),
('112110', 'Cincinnati Plant', 'SITE', '112100', 'USA', 'OH', 'Cincinnati', 'PROD', 'PLANT', TRUE);

-- Distribution Centers
INSERT INTO reporting_locations (location_code, location_name, location_level, parent_location, country_code, state_province, city, business_area_id, location_type, is_distribution) VALUES
('113000', 'USA - West', 'STATE', '110000', 'USA', 'CA', NULL, 'NA', 'DC', TRUE),
('113100', 'California Distribution', 'CITY', '113000', 'USA', 'CA', 'Los Angeles', 'NA', 'DC', TRUE),
('113110', 'LA Distribution Center', 'SITE', '113100', 'USA', 'CA', 'Los Angeles', 'NA', 'DC', TRUE);
...
-- =====================================================
-- 5. INSERT SAMPLE PRODUCT LINE DATA
-- =====================================================
...
INSERT INTO product_lines (product_line_id, product_line_name, short_name, parent_product_line, product_category, product_family, business_area_id, lifecycle_stage, industry_sector, is_service, is_digital) VALUES
('210000', 'ERP Solutions', 'ERP', '200000', 'Software', 'Enterprise', 'TECH', 'MATURITY', 'TECHNOLOGY', FALSE, TRUE),
('211000', 'Financial ERP', 'FIN-ERP', '210000', 'Software', 'Enterprise', 'TECH', 'MATURITY', 'TECHNOLOGY', FALSE, TRUE),
('212000', 'Supply Chain ERP', 'SCM-ERP', '210000', 'Software', 'Enterprise', 'TECH', 'GROWTH', 'TECHNOLOGY', FALSE, TRUE),
('220000', 'Cloud Services', 'Cloud', '200000', 'Software', 'Cloud', 'TECH', 'GROWTH', 'TECHNOLOGY', TRUE, TRUE),
('221000', 'SaaS Applications', 'SaaS', '220000', 'Software', 'Cloud', 'TECH', 'GROWTH', 'TECHNOLOGY', TRUE, TRUE),
('222000', 'Infrastructure Services', 'IaaS', '220000', 'Software', 'Cloud', 'TECH', 'GROWTH', 'TECHNOLOGY', TRUE, TRUE);

-- Professional Services Sub-Lines
INSERT INTO product_lines (product_line_id, product_line_name, short_name, parent_product_line, product_category, business_area_id, lifecycle_stage, industry_sector, is_service) VALUES
('310000', 'Management Consulting', 'MC', '300000', 'Services', 'SERV', 'MATURITY', 'SERVICES', TRUE),
('320000', 'Technology Consulting', 'TC', '300000', 'Services', 'SERV', 'GROWTH', 'SERVICES', TRUE),
('330000', 'Implementation Services', 'IS', '300000', 'Services', 'SERV', 'MATURITY', 'SERVICES', TRUE);

-- Industrial Products Sub-Lines
INSERT INTO product_lines (product_line_id, product_line_name, short_name, parent_product_line, product_category, business_area_id, lifecycle_stage, industry_sector, is_manufactured) VALUES
('410000', 'Machinery', 'MACH', '400000', 'Industrial', 'PROD', 'MATURITY', 'MANUFACTURING', TRUE),
('420000', 'Components', 'COMP', '400000', 'Industrial', 'PROD', 'MATURITY', 'MANUFACTURING', TRUE),
('430000', 'Raw Materials', 'RAW', '400000', 'Industrial', 'PROD', 'MATURITY', 'MANUFACTURING', FALSE);

-- Consumer Goods Sub-Lines
INSERT INTO product_lines (product_line_id, product_line_name, short_name, parent_product_line, product_category, business_area_id, lifecycle_stage, industry_sector, requires_lot_tracking) VALUES
('510000', 'Food Products', 'FOOD', '500000', 'FMCG', 'PROD', 'MATURITY', 'CPG', TRUE),
('511000', 'Beverages', 'BEV', '510000', 'FMCG', 'PROD', 'MATURITY', 'CPG', TRUE),
('512000', 'Snacks', 'SNACK', '510000', 'FMCG', 'PROD', 'GROWTH', 'CPG', TRUE),
('520000', 'Personal Care', 'PC', '500000', 'FMCG', 'PROD', 'MATURITY', 'CPG', TRUE),
('521000', 'Skincare', 'SKIN', '520000', 'FMCG', 'PROD', 'GROWTH', 'CPG', TRUE),
('522000', 'Haircare', 'HAIR', '520000', 'FMCG', 'PROD', 'MATURITY', 'CPG', TRUE);

-- Healthcare/Pharma Sub-Lines
INSERT INTO product_lines (product_line_id, product_line_name, short_name, parent_product_line, product_category, business_area_id, lifecycle_stage, industry_sector, regulatory_classification, requires_serialization, requires_lot_tracking) VALUES
('610000', 'Prescription Drugs', 'RX', '600000', 'Healthcare', 'PROD', 'MATURITY', 'PHARMA', 'PRESCRIPTION', TRUE, TRUE),
('611000', 'Oncology', 'ONCO', '610000', 'Healthcare', 'PROD', 'GROWTH', 'PHARMA', 'PRESCRIPTION', TRUE, TRUE),
('612000', 'Cardiovascular', 'CARDIO', '610000', 'Healthcare', 'PROD', 'MATURITY', 'PHARMA', 'PRESCRIPTION', TRUE, TRUE),
('620000', 'OTC Products', 'OTC', '600000', 'Healthcare', 'PROD', 'MATURITY', 'PHARMA', 'OTC', FALSE, TRUE),
('630000', 'Medical Devices', 'MD', '600000', 'Healthcare', 'PROD', 'GROWTH', 'PHARMA', 'MEDICAL_DEVICE', TRUE, TRUE);
...
WITH RECURSIVE location_tree AS (
    SELECT 
        ...
        l.location_level,
        l.parent_location,
        l.location_code AS path,
        l.location_name AS full_path,
        0 AS level
    ...
    SELECT 
        ...
        l.location_level,
        l.parent_location,
        lt.path || '/' || l.location_code AS path,
...
WITH RECURSIVE product_tree AS (
    SELECT 
        ...
        p.product_category,
        p.product_line_id AS path,
        p.product_line_name AS full_path,
        0 AS level
    ...
    SELECT 
        ...
        p.parent_product_line,
        p.product_category,
        pt.path || '/' || p.product_line_id AS path,
        pt.full_path || ' > ' || p.product_line_name AS full_path,
        pt.level + 1 AS level
    FROM product_lines p
...
-- Cost Center Enhanced View with Location and Product Line
...
-- Profit Center Enhanced View with Location and Product Line
...
LEFT JOIN profit_center_location_product plp ON pc.profitcenterid = plp.profit_center_id
