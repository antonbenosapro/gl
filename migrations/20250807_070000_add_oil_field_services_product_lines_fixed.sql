-- =====================================================
-- Add Oil Field Services Product Lines (FIXED)
-- =====================================================
-- Author: Claude Code Assistant
-- Date: August 7, 2025
-- Description: Add comprehensive oil field services product lines
--              Fixed version addressing constraints and data types
-- =====================================================
...
-- Step 4: Add LEVEL 2 Specific Service Lines
INSERT INTO product_lines (
    product_line_id, product_line_name, short_name, parent_product_line,
    product_category, product_family, business_area_id, lifecycle_stage, industry_sector,
...
('7430', 'Microseismic Monitor', 'MICRO', '7400', 'Energy Services', 'Exploration', 'ENGY', 'GROWTH', 'ENERGY',
